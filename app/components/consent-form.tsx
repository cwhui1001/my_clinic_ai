...
export function ConsentForm({ clinicName, initialPhone }: { clinicName: string; initialPhone: string }) {
  ...
  return (
    <form onSubmit={submit} className="mt-7 space-y-5">
      ...
      <p className="text-xs leading-5 text-slate-500">Consent record: {HEALTHCARE_CONSENT_NOTICE_VERSION}. This consent is separate from marketing permission.</p>
...
function conversionError(code: string) {
  ...
  if (code === "email_unverified") return "Verify your email before providing consent.";
